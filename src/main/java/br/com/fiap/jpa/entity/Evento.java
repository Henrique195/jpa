...
public class Evento implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 850878518148777110L;
	...
	@Column(name = "ds_evento", length = 80, nullable = false)
	...
	public String toString() {
		...
		return "\nDescricão: " + this.getDescricao() 
			+ "\nData do evento: " + this.getDataEvento();
