...
@SequenceGenerator(name = "participante", sequenceName = "sq_t_gce_partipante", allocationSize = 1)

public class Participante implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8975315997620420659L;

	public Participante() {
		
	}
	
	public Participante(String nome, LocalDate dataNascimento, String cpf, String rg,
