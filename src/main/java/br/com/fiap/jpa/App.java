...
public class App {
	...
	public static void main(String[] args) {
		...
		MovimentacaoEntradaServiceImpl movimentacaoEntradaService = MovimentacaoEntradaServiceImpl.getInstance();
		ParticipanteServiceImpl participanteService = ParticipanteServiceImpl.getInstance();
		
		/**
		 * Cadastrando um novo evento
		 */
		Evento evento = new Evento("Niver da Ester", LocalDate.of(2022, 06, 10));
		 ...
		 */
		movimentacaoEntradaService.listarPorTipo("S").forEach(System.out::println);
